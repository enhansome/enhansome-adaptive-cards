...
* [Adaptive Cards](https://github.com/microsoft/AdaptiveCards) ⭐ 1,957 | 🐛 889 | 🌐 C# | 📅 2026-08-13 - A new way for developers to exchange card content in a common and consistent way.
...
* [SharePoint WebParts](https://github.com/pnp/sp-dev-fx-webparts/tree/main/samples/react-adaptivecards) ⭐ 2,256 | 🐛 28 | 🌐 TypeScript | 📅 2026-08-13 - Adaptive Cards Web Part.
...
* [Adaptive Cards Scenarios](https://github.com/microsoft/AdaptiveCards/tree/main/samples/Templates/Scenarios) ⭐ 1,957 | 🐛 889 | 🌐 C# | 📅 2026-08-13 - Sample scenarios from Adaptive Cards.
...
* [PSTeams](https://github.com/EvotecIT/PSTeams) ⭐ 442 | 🐛 9 | 🌐 C# | 📅 2026-08-10 - PowerShell Module that allows sending notifications to Microsoft Teams via WebHook Notifications.
...
* [MS Teams Incoming Webhook](https://github.com/mikesprague/teams-incoming-webhook-action) ⭐ 24 | 🐛 1 | 🌐 TypeScript | 📅 2026-08-13 - GitHub Action that sends an AdaptiveCard notification to an MS Teams Incoming Webhook.
